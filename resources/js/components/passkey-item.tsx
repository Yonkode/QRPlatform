    ...
    return (
        <div className="flex items-center justify-between border-b p-4 last:border-b-0">
            ...
            <Dialog>
                ...
                <DialogContent>
                    <DialogTitle>Retirer la clé d'accès</DialogTitle>
                    <DialogDescription>
                        Es-tu sûr de vouloir retirer la clé d'accès « {passkey.name} » ?
                        Tu ne pourras plus t'en servir pour te connecter.
                    </DialogDescription>
                    <DialogFooter className="gap-2">
                        ...
                        <Button
                            ...
                            disabled={isDeleting}
                        >
                            {isDeleting ? 'Suppression...' : "Retirer la clé d'accès"}
                        </Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
